...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-xK8SRSEI.mjs");
...
const manifest = {
  "9277ff05e4ed7bb93dcc50c07d49074d2c32ad187e0b1bd2e1c50b357289d897": {
    functionName: "removeBackgroundServer_createServerFn_handler",
    importer: () => import("./remove-bg.server-CB2U8gbc.mjs")
  },
  "bab8c29a056825a138d325bde479c415c8b94748881635f4a4b7aeef253338ef": {
    functionName: "getProcessedImageUrl_createServerFn_handler",
    importer: () => import("./get-result.server-G05Deeb6.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-g-9W6oFX.mjs"),
    import("./start-DE9fqwY1.mjs"),
