  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="max-w-md text-center">
        ...
        <a href="/" className="mt-6 inline-flex h-10 items-center rounded-full px-5 text-sm font-medium text-white gradient-bg">
          Go home
        </a>
      </div>
    </div>
    ...
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex justify-center gap-2">
          ...
          >Try again</button>
          <a href="/" className="inline-flex h-10 items-center rounded-full border border-border px-5 text-sm">Home</a>
        </div>
      </div>
    </div>
  );
